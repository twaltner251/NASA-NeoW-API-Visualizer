...
* **Star Generation:** I initially tried generating the background stars using random XYZ coordinates with rejetion sampling to get them to generate within a specific range. (specified in constants.js: 'STARS_INNER_BOUND' & 'STARS_OUTER_BOUND') 
